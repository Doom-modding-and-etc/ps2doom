 ...
 *
 * static const char rcsid[] = "$Id: s_sound.c,v 1.10 1999/10/12 13:01:14
 *cphipps Exp $";
 *-----------------------------------------------------------------------------*/
...
void S_StopMusic(void) {
  ...
  if (mus_playing) {
    ...
    // cosmito : W_UnlockLumpNum needs to be implemented. Since music is
    // currently disabled, I commented this line
