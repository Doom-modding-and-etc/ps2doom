...
int P_NextWeapon(player_t *player) {
  ...
  if (newweapon == NUMWEAPONS) {
    if (player->weaponowned[wp_chaingun] &&
        player->ammo[am_clip]) /// cosmito : to comply to below (wp_chaingun
                               /// should follow wp_supershotgun)
      newweapon = wp_chaingun;
    else
      newweapon = wp_fist;
  }

  /// cosmito : seems natural to switch from a wp_shotgun to a wp_supershotgun
  /// (index 3 to index 8)
...
//    if (newweapon == NUMWEAPONS)
//        if (player->weaponowned[wp_chaingun] && player->ammo[am_clip]) ///
//        cosmito : to comply to below (wp_chaingun should follow
//        wp_supershotgun)
//            newweapon = wp_chaingun;
//        else
//            newweapon = wp_fist;
//
//    /// cosmito : seems natural to switch from a wp_shotgun to a
//    wp_supershotgun (index 3 to index 8) if (currentweapon == wp_shotgun)
//        if (player->weaponowned[wp_supershotgun] && gamemode == commercial &&
//        player->ammo[am_shell] >= (demo_compatibility ? 3 : 2))
//            newweapon = wp_supershotgun;
//
...

{
  ...
  /// cosmito : seems natural to switch from a wp_supershotgun to a wp_shotgun
  /// (index 8 to index 2)
  ...
  if (newweapon < wp_fist) {
    ...
    newweapon =
        NUMWEAPONS - 1 -
        1; /// cosmito : actually, wp_chainsaw instead of wp_supershotgun
    // pf("newweapon < wp_fist, if (newweapon < wp_fist), newweapon = NUMWEAPONS
    // - 1; newweapon = %d\n", newweapon );
  }
...
// pf("\n\ncurrentweapon = %d\n", currentweapon );
//
//    /// cosmito : seems natural to switch from a wp_supershotgun to a
//    wp_shotgun (index 8 to index 2) if (currentweapon == wp_supershotgun)
//        if (player->weaponowned[wp_shotgun] && player->ammo[am_shell])
//            newweapon = wp_shotgun + 1;
//
//    /// cosmito : to comply to above (wp_supershotgun should follow
//    wp_chaingun) if (currentweapon == wp_chaingun)
//        if (player->weaponowned[wp_supershotgun] && gamemode == commercial &&
//        player->ammo[am_shell] >= (demo_compatibility ? 3 : 2))
//            newweapon = wp_supershotgun + 1;
//
...
//            // ?
//            //case 1:
//            //  if (!player->powers[pw_strength])      // allow chainsaw
//            override
//            //    break;
//    }
//
