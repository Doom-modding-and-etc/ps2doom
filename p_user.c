...
void P_PlayerThink(player_t *player) {
  ...
  if (cmd->buttons & BT_CHANGE) {
    ...
    if (demo_compatibility) /// cosmito : this check was missing from original
                            /// sources. If the code inside runs, it makes the
                            /// next/prev weapon to fail is supershotgun is
                            /// owned. I added this check from PrBoom sources
    {
      ///
