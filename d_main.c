...
#include <libpad.h>
/// cosmito
void checkForWadFile(char *wadname, char **foundwadfiles, char *foundfile,
                     int *foundwadfiles_index, int *nWadsFound);
...
struct {
  ...
  GameMission_t mission;
    ...
    {"doom.wad", doom},          {"doom2.wad", doom2}, {"tnt.wad", pack_tnt},
    {"plutonia.wad", pack_plut}, {"doom1.wad", doom},
};
...
/*
  When given an IWAD with the '-iwad' parameter, this void declaration will try
to indentify by his name
*/
...
void IdentifyVersionAndSelect(void) // cosmito
{
  ...
  /********************************************************************************************
  **   parameter commands in this case it will be just the name of parmeter like
  *int comdev; **
  ...
  *********************************************************************************************/
  ...
  if (iwadparm) {
    ...
    if (doomiwaddir != NULL) {
      ...
      result = Find_IWADS_Dir(".") || Find_IWADS_Dir("mass0:/ps2doom") ||
               Find_IWADS_Dir("pfs0:/ps2doom");
    }
  ...
  checkForWadFile(doom2fwad, foundwadfiles, foundfile, &foundwadfiles_index,
                  &nWadsFound);
  checkForWadFile(doom2wad, foundwadfiles, foundfile, &foundwadfiles_index,
                  &nWadsFound);
  checkForWadFile(plutoniawad, foundwadfiles, foundfile, &foundwadfiles_index,
                  &nWadsFound);
  checkForWadFile(tntwad, foundwadfiles, foundfile, &foundwadfiles_index,
                  &nWadsFound);
  checkForWadFile(doomuwad, foundwadfiles, foundfile, &foundwadfiles_index,
                  &nWadsFound);
  checkForWadFile(doomwad, foundwadfiles, foundfile, &foundwadfiles_index,
                  &nWadsFound);
  checkForWadFile(doom1wad, foundwadfiles, foundfile, &foundwadfiles_index,
                  &nWadsFound);
  ...
  if (nWadsFound > 0) {
    ...
    if (strcmp(doom2fwad, selected_wad) == 0) {
      ...
      //// halves sample playing frequency to avoid lack of memory for the
      ///upsampled sounds
      // mixer_period = 2;
...
void D_DoomMain(void) {
  ...
  if (modifiedgame) {
    /*m*/ printf("============================================================="
                 "==============\n"
                 "     PS2DOOM is free software, covered by the DOOM Source "
                 "Code\n               "
                 "     License. However WITHOUT ANY WARRANTY even the implied "
                 "warranty of      "
                 "     FITNESS FOR A PARTICULAR PURPOSE. See the DOOM Source "
                 "Code License for more details.\n"
                 "     You are welcome to change and distribute but you can´t "
                 "sell comercially.\n"
  ...
  case commercial:
    printf("==================================================================="
           "========\n"
           "         Open source product - you can do distributions or modify "
           "the code!\n"
  ...
  // cosmito : SDL_Init is inited here. scr_printf calls results in strange
  // characters then.
